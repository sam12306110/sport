    ...
    <div id="datashow">
      <table border="0" cellspacing="1" cellpadding="0" bgcolor="#ACACAC" class="box">
        ...
        <tr>
          ...
          <th class="duying" v-if="dataType==2">独赢</th>
          <th class="rangqiu">让分</th>
          <th class="daxiao">大小</th>
          <th class="rangqiu">单双</th>
        </tr>
        <!--<tr>-->
            ...
            <div>
              <table border="0" cellspacing="1" cellpadding="0" bgcolor="#ACACAC" class="box">
                <tr v-for="items in item">
                  ...
                  <td class="zhong line" v-if="dataType==2">
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    data () {
      return {
        action:'../api/app/member/show/json/tennis_2.php',
        showType:'早餐-单式',
        time: 120,
        showModel: {
          modelClose: false,
    ...
    mounted: function () {
      ...
      if(_self.dataType==1){
        _self.action= '../api/app/member/show/json/tennis_2.php';
        _self.showType='早餐-单式'
      }
      if(_self.dataType==2){
        _self.action= '../api/app/member/show/json/tennis.php';
        _self.showType='今日-单式'
      }
