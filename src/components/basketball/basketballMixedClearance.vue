            ...
            <div>
              <table border="0" cellspacing="1" cellpadding="0" bgcolor="#ACACAC" class="box">
                <tr v-for="items in item">
                  ...
                  <td class="zhong line">
                    <a  @click="ClickBet('篮球单式',key,items.Match_ID,items.Match_Date,{zhu:items.Match_Master,ke:items.Match_Guest},items.Match_Master,items.Match_BzM,'1','Match_BzM','','独赢')" v-if="items.Match_BzM!=null&&items.Match_BzM!='0'" href="javascript:;">{{items.Match_BzM}}</a>
                    <br>
                    <a @click="ClickBet('篮球单式',key,items.Match_ID,items.Match_Date,{zhu:items.Match_Master,ke:items.Match_Guest},items.Match_Guest,items.Match_BzG,'1','Match_BzG','','独赢')" v-if="items.Match_BzG!=null&&items.Match_BzG!='0'" href="javascript:;">{{items.Match_BzG}}</a>
                    <br>
                    <a @click="ClickBet('篮球单式',key,items.Match_ID,items.Match_Date,{zhu:items.Match_Master,ke:items.Match_Guest},'和局',items.Match_BzH,'1','Match_BzH','','和局')" v-if="items.Match_BzH!=null&&items.Match_BzH!='0'" href="javascript:;">{{items.Match_BzH}}</a>
                    <br>
                  </td>
                  <td width="140px">
                    <div class="rangqiu_odds">
                           <span class="odds">
                          <a @click="ClickBet('篮球单式',key,items.Match_ID,items.Match_Date,{zhu:items.Match_Master,ke:items.Match_Guest},items.Match_Master,items.Match_Ho,'1','Match_Ho','盘口: '+(items.Match_ShowType=='H' ? '主让' :'客让')+'('+items.Match_RGG+')')" v-if="items.Match_Ho!=null&&items.Match_Ho!='0'" href="javascript:;">{{items.Match_Ho}}</a>
                           </span>
                      <span v-if="items.Match_Ho!=null&&items.Match_Ho!='0'" class="pankou">{{items.Match_ShowType=="H" && items.Match_Ho!="0"?items.Match_RGG:""}}</span>
                      <br>
                      <span class="odds">
                          <a @click="ClickBet('篮球单式',key,items.Match_ID,items.Match_Date,{zhu:items.Match_Master,ke:items.Match_Guest},items.Match_Guest,items.Match_Ao,'1','Match_Ao','盘口: '+(items.Match_ShowType=='H' ? '主让' :'客让')+'('+items.Match_RGG+')')"v-if="items.Match_Ao!=null&&items.Match_Ao!='0'" href="javascript:;">{{items.Match_Ao}}</a>
                          </span>
                  ...
                  <td width="138px">
                    <div class="rangqiu_odds">
                         <span class="odds">
                           <a @click="ClickBet('篮球单式',key,items.Match_ID,items.Match_Date,{zhu:items.Match_Master,ke:items.Match_Guest},items.Match_DxGG1,items.Match_DxDpl,'1','Match_DxDpl')" v-if="items.Match_DxDpl!=null&&items.Match_DxDpl!='0'" href="javascript:;" title="大">
                               {{items.Match_DxDpl}}
                           </a>
                          </span>
                      ...
                      <br>
                      <span class="odds">
                          <a @click="ClickBet('篮球单式',key,items.Match_ID,items.Match_Date,{zhu:items.Match_Master,ke:items.Match_Guest},items.Match_DxGG2,items.Match_DxXpl,'1','Match_DxXpl')" v-if="items.Match_DxXpl!=null&&items.Match_DxXpl!='0'" href="javascript:;" title="小" >
                            {{items.Match_DxXpl}}
                         </a>
                         </span>
                  ...
                  <td width="138px">
                    <div class="rangqiu_odds">
                         <span class="odds">
                           <a @click="ClickBet('篮球单式',key,items.Match_ID,items.Match_Date,{zhu:items.Match_Master,ke:items.Match_Guest},'单',items.Match_DsDpl,'1','Match_DsDpl','','单双')" v-if="items.Match_DsDpl!=null&&items.Match_DsDpl!='0'" href="javascript:;" title="大">
                               {{items.Match_DsDpl}}
                           </a>
                         </span>
                      ...
                      <br>
                      <span class="odds">
                          <a @click="ClickBet('篮球单式',key,items.Match_ID,items.Match_Date,{zhu:items.Match_Master,ke:items.Match_Guest},'双',items.Match_DsDpl,'1','Match_DsDpl','','单双')" v-if="items.Match_DsSpl!=null&&items.Match_DsSpl!='0'" href="javascript:;" title="小" >
                            {{items.Match_DsSpl}}
                          </a>
                         </span>
