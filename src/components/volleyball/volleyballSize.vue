...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    data() {
      return {
        action: '../api/app/member/show/json/volleyball_2.php',
        showType: '早餐-单式',
        time: 120,
        showModel: {
          modelClose: false,
    ...
    mounted: function () {
      ...
      if (_self.dataType == 1) {
        _self.action = '../api/app/member/show/json/volleyball_2.php'
        this.showType = '早餐-单式'
      }
      if (_self.dataType == 2) {
        _self.action = '../api/app/member/show/json/volleyball.php'
        this.showType = '今日-单式'
      }
