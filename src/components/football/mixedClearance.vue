  ...
  <div>
    ...
    <div id="datashow">
      <table border="0" cellspacing="1" cellpadding="0" bgcolor="#ACACAC" class="box">
        ...
        <!--<tr>-->
        <!--<td height="100" colspan="9" align="center" bgcolor="#FFFFFF">暂无任何赛事</td>-->
        <!--</tr>-->
        <tr>
              ...
              <table border="0" cellspacing="1" cellpadding="0" bgcolor="#ACACAC" class="box">
                <tr v-for="items in item">
                  ...
                  <td class="zhong line" width="40px">
                    <a href="javascript:;"
                       @click="ClickBet('足球单式',key,items.Match_ID,items.Match_Date,{zhu:items.Match_Master,ke:items.Match_Guest},items.Match_Master,items.Match_BzM,'1','Match_BzM','','独赢')"
                       v-if="items.Match_BzM!=null&&items.Match_BzM!='0'">{{items.Match_BzM}}</a>
                    <br>
                    <a href="javascript:;"
                       @click="ClickBet('足球单式',key,items.Match_ID,items.Match_Date,{zhu:items.Match_Master,ke:items.Match_Guest},items.Match_Guest,items.Match_BzG,'1','Match_BzG','','独赢')"
                       v-if="items.Match_BzG!=null&&items.Match_BzG!='0'">{{items.Match_BzG}}</a>
                    <br>
                    <a href="javascript:;" @click="ClickBet('足球单式',key,items.Match_ID,items.Match_Date,{zhu:items.Match_Master,ke:items.Match_Guest},'和局',items.Match_BzH,'1','Match_BzH','','和局')"
                  ...
                  <td width="95px">
                    ...
                    <span class="odds" v-if="items.Match_Ho!=null&&items.Match_Ho!='0'">
                          <a href="javascript:;"
                             @click="ClickBet('足球单式',key,items.Match_ID,items.Match_Date,{zhu:items.Match_Master,ke:items.Match_Guest},items.Match_Master,items.Match_Ho,'1','Match_Ho','盘口: '+(items.Match_ShowType=='H' ? '主让' :'客让')+'('+items.Match_RGG+')')">{{items.Match_Ho}}</a>
                       </span>
                      <span class="pankou"
                      ...
                      <span class="odds" v-if="items.Match_Ao!=null&&items.Match_Ao!='0'">
                          <a href="javascript:;"
                             @click="ClickBet('足球单式',key,items.Match_ID,items.Match_Date,{zhu:items.Match_Master,ke:items.Match_Guest},items.Match_Guest,items.Match_Ao,'1','Match_Ao','盘口: '+(items.Match_ShowType=='H' ? '主让' :'客让')+'('+items.Match_RGG+')')">{{items.Match_Ao}}</a>
                       </span>
                      <span class="pankou"
                  ...
                  <td width="95px">
                    <div class="rangqiu_odds">
                         <span class="odds" v-if="items.Match_DxDpl!=null&&items.Match_DxDpl!='0'">
                             <a href="javascript:;"
                                @click="ClickBet('足球单式',key,items.Match_ID,items.Match_Date,{zhu:items.Match_Master,ke:items.Match_Guest},items.Match_DxGG1,items.Match_DxDpl,'1','Match_DxDpl')">{{items.Match_DxDpl}}</a>
                         </span>
                      <span class="pankou"
                      ...
                      <span class="odds">
                         <a href="javascript:;"
                            @click="ClickBet('足球单式',key,items.Match_ID,items.Match_Date,{zhu:items.Match_Master,ke:items.Match_Guest},items.Match_DxGG2,items.Match_DxXpl,'1','Match_DxXpl')"
                  ...
                  <td class="zhong" width="95px">
                    <a href="javascript:;" @click="ClickBet('足球单式',key,items.Match_ID,items.Match_Date,{zhu:items.Match_Master,ke:items.Match_Guest},'单',items.Match_DsDpl,'1','Match_DsDpl','','单双')"
                       v-if="items.Match_DsDpl!=null&&items.Match_DsDpl!='0'"><span
                      style="color: black">单：</span>{{items.Match_DsDpl}}</a><br>
                    <a href="javascript:;" @click="ClickBet('足球单式',key,items.Match_ID,items.Match_Date,{zhu:items.Match_Master,ke:items.Match_Guest},'双',items.Match_DsDpl,'1','Match_DsDpl','','单双')"
                       v-if="items.Match_DsSpl!=null&&items.Match_DsSpl!='0'"><span
                      style="color: black">双：</span>{{items.Match_DsSpl}}</a><br>
                  </td>
                  <td class="zhong line" width="40px">
                    <a href="javascript:;"
                       @click="ClickBet('足球单式',key,items.Match_ID,items.Match_Date,{zhu:items.Match_Master,ke:items.Match_Guest},items.Match_Master+'-[上半]',items.Match_Bmdy,'1','Match_Bmdy','','独赢')"
                       v-if="items.Match_Bmdy!=null&&items.Match_Bmdy!='0'">{{items.Match_Bmdy}}</a><br>
                    <a href="javascript:;"
                       @click="ClickBet('足球单式',key,items.Match_ID,items.Match_Date,{zhu:items.Match_Master,ke:items.Match_Guest},items.Match_Guest+'-[上半]',items.Match_Bgdy1,'1','Match_Bgdy1','','独赢')"
                       v-if="items.Match_Bgdy1!=null&&items.Match_Bgdy1!='0'">{{items.Match_Bgdy1}}</a><br>
                    <a href="javascript:;"
                       @click="ClickBet('足球单式',key,items.Match_ID,items.Match_Date,{zhu:items.Match_Master,ke:items.Match_Guest},'和局',items.Match_Bhdy1,'1','Match_Bhdy1','','单双')"
                  ...
                  <td width="95px">
                    <div class="rangqiu_odds">
                      <span class="odds">
                          <a href="javascript:;"
                             @click="ClickBet('足球单式',key,items.Match_ID,items.Match_Date,{zhu:items.Match_Master,ke:items.Match_Guest},items.Match_Master,items.Match_BHo,'1','Match_BHo','盘口: '+(items.Match_Hr_ShowType=='H'?'主让':'客让')+'('+items.Match_RGG+')')"
                      ...
                      <span class="odds" v-if="items.Match_BAo!=null&&items.Match_BAo!='0'">
                          <a href="javascript:;"
                             @click="ClickBet('足球单式',key,items.Match_ID,items.Match_Date,{zhu:items.Match_Master,ke:items.Match_Guest},items.Match_Guest,items.Match_BAo,'1','Match_BAo','盘口: '+(items.Match_Hr_ShowType=='H'?'主让':'客让')+'('+items.Match_RGG+')')">{{items.Match_BAo}}</a>
                       </span>
                      <span class="pankou"
                  ...
                  <td width="95px">
                    <div class="rangqiu_odds">
                       <span class="odds" v-if="items.Match_Bdpl!=null&&items.Match_Bdpl!='0'">
                           <a href="javascript:;"
                              @click="ClickBet('足球单式',key,items.Match_ID,items.Match_Date,{zhu:items.Match_Master,ke:items.Match_Guest},items.Match_Bdxpk1.replace('@',''),items.Match_Bdpl,'1','Match_Bdpl')"
                              title="大">
                               {{items.Match_Bdpl}}
                           </a>
                       </span>
                      ...
                      <span class="odds" v-if="items.Match_Bdpl!=null&&items.Match_Bdpl!='0'">
                        <a href="javascript:;"
                           @click="ClickBet('足球单式',key,items.Match_ID,items.Match_Date,{zhu:items.Match_Master,ke:items.Match_Guest},items.Match_Bdxpk2.replace('@',''),items.Match_Bxpl,'1','Match_Bxpl')"
                           title="小">
                            {{items.Match_Bxpl}}
                        </a>
                      </span>
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    mounted: function () {
      ...
      _self.$store.state.betData.tzType=2;
